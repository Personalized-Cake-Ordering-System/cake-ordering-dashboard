  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        onClose();
        router.push("/dashboard/bakeries");
        router.refresh();
      } else {
        toast({
          title: "Lỗi",
    ...
    switch (status) {
      ...
      case "BANNED":
        return (
          <Badge
            variant="outline"
            className="bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-100 border-red-200"
          >
            Đã cấm
          </Badge>
        );
                    ...
                    <div className="space-y-0.5 flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1 text-xs">
                        ...
                        <span className="truncate">
                          {formatTime(bakery.open_time)} -{" "}
                          {formatTime(bakery.close_time)}
                        </span>
                      </div>
                    </div>
                  </div>
                      ...
                      <Card className="shadow-sm border">
                        ...
                        <CardContent className="py-1 px-2 space-y-1">
                          <div>
                            ...
                            <p className="text-xs">
                              {bakery.cake_description || "Không có"}
                            </p>
                          </div>
                          <div>
                            <p className="text-xs font-medium text-muted-foreground">
                            ...
                            <p className="text-xs">
                              {bakery.price_description || "Không có"}
                            </p>
                          </div>
                          <div>
                            <p className="text-xs font-medium text-muted-foreground">
                            ...
                            <p className="text-xs">
                              {bakery.bakery_description || "Không có"}
                            </p>
                          </div>
                          <div>
                            <p className="text-xs font-medium text-muted-foreground">
                            ...
                            <div className="grid grid-cols-2 gap-1">
                              <div>
                                ...
                                <p className="text-xs font-semibold">
                                  {bakery.metric.total_revenue.toLocaleString()}{" "}
                                  đ
                                </p>
                              </div>
                              <div>
                                ...
                                <p className="text-xs font-semibold">
                                  {bakery.metric.app_revenue.toLocaleString()} đ
                                </p>
                              </div>
                              <div>
                                <p className="text-xs font-medium text-muted-foreground">
                              ...
                              <div>
                                ...
                                <p className="text-xs font-semibold">
                                  {bakery.metric.average_order_value.toLocaleString()}{" "}
                                  đ
                                </p>
                              </div>
                            </div>
