...
import { deleteCakeExtraOption } from "@/features/ingredients/actions/cake-extra-option-action";
...
export function CakeExtraOptionTable({ data }: CakeExtraOptionTableProps) {
  ...
  const handleDelete = async (id?: string) => {
    startTransition(async () => {
      const result = await deleteCakeExtraOption(id!);
      if (result.success) {
